...
struct ValidExpressionPrefixTests {
    @Test<[(Quantity, String, String)]>("parse and format from Quantity (inches)", arguments: [
        (.rational(rational(0, 1), .length), "0in[1]", "0\""),
        (.rational(rational(1, 2), .length), "1/2in[1]", "¹⁄₂\""),
        (.rational(rational(1, -2), .length), "-1/2in[1]", "-¹⁄₂\""),
        (.rational(rational(6, 1), .length), "6in[1]", "6\""),
        (.rational(rational(12, 1), .length), "12in[1]", "12\""),
        (.rational(rational(48, 1), .length), "48in[1]", "48\""),
        (.rational(rational(13, 1), .length), "13in[1]", "13\""),
        (.rational(rational(49, 1), .length), "49in[1]", "49\""),
        (.rational(rational(99, 2), .length), "49 1/2in[1]", "49 ¹⁄₂\""),
    ...
    @Test<[(Quantity, String, String)]>("parse and format from Quantity (feet and inches)", arguments: [
        (.rational(rational(0, 1), .length), "0in[1]", "0\""),
        (.rational(rational(6, 1), .length), "6in[1]", "6\""),
        (.rational(rational(12, 1), .length), "1ft[1]", "1'"),
        (.rational(rational(48, 1), .length), "4ft[1]", "4'"),
        (.rational(rational(25, 2), .length), "1ft[1] 1/2in[1]", "1' ¹⁄₂\""),
        (.rational(rational(-25, 2), .length), "-1ft[1] 1/2in[1]", "-1' ¹⁄₂\""),
        (.rational(rational(13, 1), .length), "1ft[1] 1in[1]", "1' 1\""),
        (.rational(rational(49, 1), .length), "4ft[1] 1in[1]", "4' 1\""),
        (.rational(rational(99, 2), .length), "4ft[1] 1 1/2in[1]", "4' 1 ¹⁄₂\""),
